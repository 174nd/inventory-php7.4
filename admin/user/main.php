...
if (isset($_POST['delete-user'])) {
  ...
  if (mysqli_num_rows($cekdata) > 0) {
    ...
    if (setDelete('user', ['id_user' => $_POST['id_user']])) {
  ...
  if (mysqli_num_rows($cekdata) > 0) {
    $isiVal = [
      ...
      'usrn' => $ada['usrn'],
      'pass' => $ada['pass'],
      'foto_user' => ($ada['foto_user'] == null) ? "Choose file" : substr($ada['foto_user'], strlen($ada['usrn'] . ' - ')),
    ...
    if (isset($_POST["Simpan"])) {
      ...
      if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM user WHERE usrn='$_POST[usrn]' AND id_user!='$_GET[id_user]'")) > 0) {
        ...
        $upFile = uploadFile($_FILES['foto_user'], ['jpg', 'jpeg', 'png'], $backurl . "uploads/users", $_POST['usrn'] . ' - ', $isiVal['asal_foto_user']);
  ...
  if (isset($_POST["Simpan"])) {
    $_POST = setData($_POST);
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM user WHERE usrn='$_POST[usrn]'")) > 0) {
      $_SESSION['duplikasi'] = 'Usename';
      $isiVal = [
        'nm_user' =>  $_POST['nm_user'],
        'akses' =>  $_POST['akses'],
      ...
      $upFile = uploadFile($_FILES['foto_user'], ['jpg', 'jpeg', 'png'], $backurl . "uploads/users", $_POST['usrn'] . ' - ');
      if ($upFile == 'Wrong Extension') {
        $_SESSION['notifikasi'] = 'NOT07';
        $isiVal = [
          'nm_user' =>  $_POST['nm_user'],
                          ...
                          <div class="row w-100 ml-0 mr-0">
                            ...
                            <div class="col-md-3 mb-2">
                              ...
                              <select name="akses" id="akses" class="form-control custom-select" required>
                                ...
                                <option value="staff" <?= cekSama($isiVal['akses'], 'staff'); ?>>Staff</option>
                        ...
                        <div class="input-group">
                          <div class="row w-100 ml-0 mr-0">
                            <div class="col-md-6 mb-2">
                              ...
                              <input type="text" name="usrn" class="form-control" id="usrn" placeholder="Username" value="<?= $isiVal['usrn']; ?>" required>
                            </div>
                            <div class="col-md-6 mb-2">
    ...
    $(function() {
      ...
      var table_user = $('#table_user').DataTable({
        ...
        "ajax": {
          ...
          "data": {
            "set_tables": "SELECT *,IF(id_user='<?= $_SESSION['id_user'] ?>',true,false) AS diss FROM user",
            'query': true
          },
          "type": "POST"
        },

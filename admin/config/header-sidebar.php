        ...
        <li class="user-body">
          <div class="row">
            <div class="col-12 text-center">
              <button type="button" class="btn btn-block btn-outline-success" data-toggle="modal" data-target="#update-password">Ganti Password</button>
            </div>
          </div>
          <!-- /.row -->
        </li>
...
<aside class="main-sidebar sidebar-light-success elevation-4 sidebar-no-expand">
  <!-- Brand Logo -->
  <a href="<?= $df['home']; ?>" class="brand-link bg-success">
    <img src="<?= $df['brand-image']; ?>" alt="Logo" class="brand-image" style="opacity: 0.8;" />
    <span class="brand-text font-weight-light">Inventaris Universitas Ibnu Sina</span>
  </a>

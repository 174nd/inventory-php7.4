...
if (isset($_POST['delete-barang'])) {
  ...
  if (mysqli_num_rows($cekdata) > 0) {
    ...
    if (setDelete('barang', ['id_barang' => $_POST['id_barang']])) {
            ...
            <ul class="list-group list-group-unbordered">
              ...
              <li class="list-group-item">
                <form method="POST" action="<?= $df['home'] . 'export/barcode.php' ?>" target="blank" class="btn-group w-100">
                  ...
                  <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete-barang">Delete</button>

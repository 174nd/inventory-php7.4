                        ...
                        <div class="input-group">
                          <div class="row w-100 ml-0 mr-0">
                            <div class="col-md-12 mb-2">
                              <div class="row">
                                <div class="col-12">
                                  <label class="float-right" for="id_ruangan"><?= $_SESSION['id_user']; ?></label>
                                </div>
                                <div class="col-12">
          ...
          success: function(data) {
            if (data['status'] == 'done') {
              ...
              $(data['hasil']).each(function(index, hasil) {
                let btn = '<div class="btn-group"><a href="' + host + 'histori/' + id_histori + '" class="btn btn-sm bg-info"><i class="fa fa-edit"></i></a></div>';
